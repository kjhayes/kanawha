...
static inline int
mmio_ecam_compute_pointer(struct pci_cam *cam,
                          uint16_t seg,
                          uint8_t bus,
                          uint8_t device,
                          uint8_t func,
                          ...
                          void **out)
{
    ...
    struct mmio_pci_ecam *ecam = container_of(cam, struct mmio_pci_ecam, cam);
...
static int
mmio_ecam_pci_readb(struct pci_cam *cam,
                    uint16_t seg,
                    uint8_t bus,
                    uint8_t device,
                    uint8_t func,
...
static int
mmio_ecam_pci_readw(struct pci_cam *cam,
                    uint16_t seg,
                    uint8_t bus,
                    uint8_t device,
                    uint8_t func,
...
static int
mmio_ecam_pci_readl(struct pci_cam *cam,
                    uint16_t seg,
                    uint8_t bus,
                    uint8_t device,
                    uint8_t func,
...
static int
mmio_ecam_pci_writeb(struct pci_cam *cam,
                     uint16_t seg,
                     uint8_t bus,
                     uint8_t device,
                     uint8_t func,
...
static int
mmio_ecam_pci_writew(struct pci_cam *cam,
                     uint16_t seg,
                     uint8_t bus,
                     uint8_t device,
                     uint8_t func,
...
static int
mmio_ecam_pci_writel(struct pci_cam *cam,
                     uint16_t seg,
                     uint8_t bus,
                     uint8_t device,
                     uint8_t func,
...
static struct pci_cam mmio_ecam_pci_cam = {
...
int
register_mmio_pci_ecam(struct mmio_pci_ecam *cam,
                       uint16_t segment_id,
                       ...
                       size_t size)
{
    ...
    res = register_pci_cam(&cam->cam, PCI_CAM_FLAG_EXTENDED);
    if(res)
    {
        return res;
    }
