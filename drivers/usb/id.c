        ...
        struct usb_id *id)
{
    switch(id->class) {
        ...
        case 0x13: return "USB Bulk Display Protocol";
        case 0x14: return "MCTP over USB Protocol Endpoint Device";
        case 0x3C: return "I3C";
        ...
        struct usb_id *id)
{
    switch(id->class) {
        case 0x09: {
        switch(id->subclass) {
            case 0x00: return "Full-Speed";
            case 0x01: return "Hi-Speed Single TT";
            case 0x02: return "Hi-Speed Multiple TT";
            default: break;
        }
        }
        case 0x10: {
        switch(id->subclass) {
            case 0x00: return "AVControl Interface";
            case 0x01: return "AVData video Streaming Interface";
            case 0x02: return "AVData Audio Streaming Interface";
            default: break;
        }
        }
        default: break;
