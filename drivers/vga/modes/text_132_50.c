        ...
        struct vga_fb *fb)
{
    ...
    vga_write_field(vga, EndHorizontalBlanking, (WIDTH & 0b111111) + 0); // Do not blank
    vga_write_field(vga, StartHorizontalRetrace, WIDTH); // Do not retrace
    vga_write_field(vga, EndHorizontalRetrace, (WIDTH & 0b11111) + 0); // Do not retrace
