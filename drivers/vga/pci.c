...
static int
vga_pci_probe(struct pci_driver *driver, struct pci_func *func)
{
...
static int
vga_pci_init_device(struct pci_driver *driver, struct pci_func *func)
{
    int res;
...
static int
vga_pci_deinit_device(struct pci_driver *driver, struct pci_func *func)
{
    int res;
...
static struct pci_id vga_pci_ids[] = {
    {
        .class = 3,
        .subclass = 0,
        .prog_if = 0,
...
static struct pci_driver_ops vga_pci_driver_ops = {
    .probe = &vga_pci_probe,
    .init_device = &vga_pci_init_device,
    .deinit_device = &vga_pci_deinit_device,
};

static struct pci_driver vga_pci_driver = {
