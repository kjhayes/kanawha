...
int
generic_8250_term_dev_irq_handler(struct excp_state *excp_state,
...
int
generic_8250_term_dev_putc(struct term_dev *term_dev, char c)
{
    struct uart_8250 *uart = container_of(term_dev, struct uart_8250, term_dev);
...
int
generic_8250_term_dev_flush(struct term_dev *term_dev)
{
    struct uart_8250 *uart = container_of(term_dev, struct uart_8250, term_dev);
    return -EUNIMPL;
}
...
int
generic_8250_term_dev_get_baudrate(struct term_dev *term_dev, baud_t *baud)
{
    struct uart_8250 *uart = container_of(term_dev, struct uart_8250, term_dev);
...
int
generic_8250_term_dev_set_baudrate(struct term_dev *term_dev, baud_t baud)
{
    struct uart_8250 *uart = container_of(term_dev, struct uart_8250, term_dev);
    return uart_set_baudrate(&uart->uart, baud);
}

struct term_driver generic_8250_term_driver = {
