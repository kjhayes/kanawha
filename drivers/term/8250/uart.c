...
int
generic_8250_uart_set_baudrate(struct uart *uart, baud_t rate)
{
    struct uart_8250 *u8250 = container_of(uart, struct uart_8250, uart);
...
int
generic_8250_uart_get_baudrate(struct uart *uart, baud_t *out)
{
    struct uart_8250 *u8250 = container_of(uart, struct uart_8250, uart);

    uint16_t dlv = ((uint16_t)uart_8250_read_reg(u8250, UART_8250_DLM) << 8) |
...
int
generic_8250_uart_set_databits(struct uart *uart, uart_databits_t bits)
{
    struct uart_8250 *u8250 = container_of(uart, struct uart_8250, uart);
...
int
generic_8250_uart_get_databits(struct uart *uart, uart_databits_t *bits)
{
    struct uart_8250 *u8250 = container_of(uart, struct uart_8250, uart);
    uint8_t lcr = uart_8250_read_reg(u8250, UART_8250_LCR);
...
int
generic_8250_uart_set_stopbits(struct uart *uart, uart_stopbits_t bits)
{
    struct uart_8250 *u8250 = container_of(uart, struct uart_8250, uart);
    uint8_t lcr = uart_8250_read_reg(u8250, UART_8250_LCR);
...
int
generic_8250_uart_get_stopbits(struct uart *uart, uart_stopbits_t *bits)
{
    struct uart_8250 *u8250 = container_of(uart, struct uart_8250, uart);
    uint8_t lcr = uart_8250_read_reg(u8250, UART_8250_LCR);
...
int
generic_8250_uart_set_parity(struct uart *uart, uart_parity_t parity)
{
    struct uart_8250 *u8250 = container_of(uart, struct uart_8250, uart);
    uint8_t lcr = uart_8250_read_reg(u8250, UART_8250_LCR);
...
int
generic_8250_uart_get_parity(struct uart *uart, uart_parity_t *parity)
{
    struct uart_8250 *u8250 = container_of(uart, struct uart_8250, uart);
...
struct uart_driver generic_8250_uart_driver = {
