...
static void
mmio_set_dlab(struct mmio_uart_8250 *uart, int dlab)
{
...
enable_reg_addr(struct uart_8250 *gen_uart, reg_8250_t reg)
{
...
static uint8_t
mmio_8250_read_reg(struct uart_8250 *uart, reg_8250_t reg)
{
...
static int
mmio_8250_write_reg(struct uart_8250 *uart, reg_8250_t reg, uint8_t value)
{
    uint8_t __mmio *addr = enable_reg_addr(uart, reg);
...
static struct uart_8250_ops mmio_uart_8250_ops = {
