...
static int
__tcgetattr_read_baudrate(int filedes, struct termios *termios_p)
{
    int baudrate_file;
...
static int
__tcgetattr_read_raw(int filedes, struct termios *termios_p)
{
    int raw_file;
...
static inline int
__tcgetattr_read_c_cc(int filedes, struct termios *termios_p)
{
...
int
tcgetattr(int filedes, struct termios *termios_p)
{
    int res;
