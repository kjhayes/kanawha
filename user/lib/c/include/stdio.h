...
int
asprintf(char **strp, const char *restrict fmt, ...);
int
...
int
vfprintf(FILE *restrict stream, const char *restrict format, __VALIST arg);
int
vfscanf(FILE *restrict stream, const char *restrict format, __VALIST arg);
int
vprintf(const char *restrict format, __VALIST arg);
int
vscanf(const char *restrict format, __VALIST arg);
int
vsnprintf(char *restrict s,
          ...
          __VALIST arg);
int
vsprintf(char *restrict s, const char *restrict format, __VALIST arg);
int
vasprintf(char **strp, const char *restrict fmt, __VALIST arg);
int
vdprintf(int fd, const char *format, __VALIST ap);
int
vsscanf(const char *restrict s, const char *restrict format, __VALIST arg);
