...
//    the implementation. Minimum Acceptable Value: {_POSIX_AIO_LISTIO_MAX}
// #define AIO_LISTIO_MAX
//    Maximum number of outstanding asynchronous I/O operations supported by the
//    implementation. Minimum Acceptable Value: {_POSIX_AIO_MAX}
// #define AIO_MAX
//    The maximum amount by which a process can decrease its asynchronous I/O
//    priority level from its own scheduling priority. Minimum Acceptable Value:
//    0
...
//    returned from the gethostname() function. Minimum Acceptable Value:
//    {_POSIX_HOST_NAME_MAX}
#define HOST_NAME_MAX 64
//    Maximum number of iovec structures that one process has available for use
//    with readv() or writev(). Minimum Acceptable Value: {_XOPEN_IOV_MAX}
// #define IOV_MAX
...
//    newly-created file descriptor. Minimum Acceptable Value: {_POSIX_OPEN_MAX}
// #define OPEN_MAX
...
//    values on thread exit. Minimum Acceptable Value:
...
//    implementation. Minimum Acceptable Value: {_POSIX_RTSIG_MAX}
// #define RTSIG_MAX
...
//    at the receiver(s) at any time. Minimum Acceptable Value:
//    {_POSIX_SIGQUEUE_MAX}
// #define SIGQUEUE_MAX
//    The maximum number of replenishment operations that may be simultaneously
//    pending for a particular sporadic server scheduler. Minimum Acceptable
//    Value: {_POSIX_SS_REPL_MAX}
// #define SS_REPL_MAX
//    Maximum number of streams that one process can have open at one time. If
//    defined, it has the same value as {FOPEN_MAX} (see <stdio.h>). Minimum
//    Acceptable Value: {_POSIX_STREAM_MAX}
// #define STREAM_MAX
//    Maximum number of symbolic links that can be reliably traversed in the
//    resolution of a pathname in the absence of a loop. Minimum Acceptable
//    Value: {_POSIX_SYMLOOP_MAX}
// #define SYMLOOP_MAX
//    Maximum number of timers per process supported by the implementation.
//    Minimum Acceptable Value: {_POSIX_TIMER_MAX}
// #define TIMER_MAX
//    Maximum length of the trace event name (not including the terminating
//    null). Minimum Acceptable Value: {_POSIX_TRACE_EVENT_NAME_MAX}
#define TRACE_EVENT_NAME_MAX 64
//    Maximum length of the trace generation version string or of the trace
//    stream name (not including the terminating null). Minimum Acceptable
//    Value: {_POSIX_TRACE_NAME_MAX}
#define TRACE_NAME_MAX 64
//    Maximum number of trace streams that may simultaneously exist in the
//    system. Minimum Acceptable Value: {_POSIX_TRACE_SYS_MAX}
...
//    trace event POSIX_TRACE_UNNAMED_USER_EVENT. Minimum Acceptable Value:
...
//    TZ variable). Minimum Acceptable Value: {_POSIX_TZNAME_MAX}
// #define TZNAME_MAX

// Runtime Values

//    Minimum number of bits needed to represent, as a signed integer value, the
//    maximum size of a regular file allowed in the specified directory. Minimum
//    Acceptable Value: 32
// #define FILESIZEBITS
...
//    require to be typed as input before reading them. Minimum Acceptable
//    Value: {_POSIX_MAX_INPUT}
// #define MAX_INPUT
//    Maximum number of bytes in a filename (not including the terminating null
//    of a filename string). Minimum Acceptable Value: {_POSIX_NAME_MAX}
#define NAME_MAX 128
...
//    number of bytes in a pathname. Minimum Acceptable Value: {_POSIX_PATH_MAX}
#define PATH_MAX 256
//    Maximum number of bytes that is guaranteed to be atomic when writing to a
//    pipe. Minimum Acceptable Value: {_POSIX_PIPE_BUF}
#define PIPE_BUF 512
//    Minimum number of bytes of storage actually allocated for any portion of a
//    file. Minimum Acceptable Value: Not specified.
// #define POSIX_ALLOC_SIZE_MIN
//    Recommended increment for file transfer sizes between the
//    {POSIX_REC_MIN_XFER_SIZE} and {POSIX_REC_MAX_XFER_SIZE} values. Minimum
//    Acceptable Value: Not specified.
