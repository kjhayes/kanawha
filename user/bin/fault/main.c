...
uint16_t tune_0[] = {
    FULL(A3) FULL(B3) FULL(D4) FULL(B3)

        DOUBLE(F4) QUARTER(REST) DOUBLE(F4) QUARTER(REST) DOUBLE(E4)

            QUAD(REST)

                FULL(A3) FULL(B3) FULL(D4) FULL(B3)

                    DOUBLE(E4) QUARTER(REST) DOUBLE(E4) QUARTER(REST) DOUBLE(D4)
                        FULL(CS4) DOUBLE(B3)
                            ...
                            QUAD(REST)
                                ...
                                FULL(A3) FULL(B3) FULL(D4) FULL(B3)
                                    ...
                                    DOUBLE(D4) DOUBLE(E4) QUAD(CS4)
                                        QUARTER(REST) FULL(A3) DOUBLE(E4)
                                            DOUBLE(D4)};
