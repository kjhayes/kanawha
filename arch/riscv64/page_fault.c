...
static int
riscv64_vmem_page_fault_handler(struct excp_state *gen_excp_state,
                                struct irq_action *action)
{
    ...
    case RISCV64_EXCP_PF_INSTR:
        ...
        break;
    default:
        panic("riscv64_vmem_page_fault_handler: invoked with invalid "
              "hwirq=0x%lx\n",
...
declare_init_desc(dynamic,
                  riscv64_install_page_fault_handler,
                  "Installing RISC-V Page Fault Handler(s)");
