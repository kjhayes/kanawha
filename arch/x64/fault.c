...
declare_init_desc(dynamic, x64_install_div_zero_fault_handler, "Installing x64 Divide By Zero Fault Handler");
...
x64_install_inval_inst_fault_handler(void)
{
    ...
    x64_inval_inst_action =
        irq_install_handler(
            x64_vector_irq_desc(6),
            NULL, // priv_state
            x64_inval_inst_fault_handler);
...
declare_init_desc(dynamic, x64_install_inval_inst_fault_handler, "Installing x64 Invalid Instruction Fault Handler");
