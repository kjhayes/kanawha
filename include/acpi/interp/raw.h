...
static inline int
acpi_interp_peek_raw_u8(struct acpi_interp_state *state, uint8_t *out)
{
...
static inline int
acpi_interp_peek_raw_u16(struct acpi_interp_state *state, uint16_t *out)
{
...
static inline int
acpi_interp_peek_raw_u32(struct acpi_interp_state *state, uint32_t *out)
{
...
static inline int
acpi_interp_peek_raw_u64(struct acpi_interp_state *state, uint64_t *out)
{
...
static inline int
acpi_interp_raw_u8(struct acpi_interp_state *state, uint8_t *out)
{
    int res;
...
static inline int
acpi_interp_raw_u16(struct acpi_interp_state *state, uint16_t *out)
{
    int res;
...
static inline int
acpi_interp_raw_u32(struct acpi_interp_state *state, uint32_t *out)
{
    int res;
...
static inline int
acpi_interp_raw_u64(struct acpi_interp_state *state, uint64_t *out)
{
    int res;
