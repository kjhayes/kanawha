#ifndef __KANAWHA__ACPI_PARSE_OPCODE_H__
#define __KANAWHA__ACPI_PARSE_OPCODE_H__
...
#ifndef KEEP_ACPI_AML_OPCODE_XLIST
#undef ACPI_AML_OPCODE_XLIST
#endif
