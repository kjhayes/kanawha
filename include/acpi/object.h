...
{
#define ACPI_OBJ_TYPE_XLIST_ENUM(__NAME, ...) ACPI_OBJ_TYPE_##__NAME,
...
const char *
acpi_field_unit_access_to_string(acpi_field_unit_access_t access);
...
const char *
acpi_field_unit_update_rule_to_string(acpi_field_unit_update_rule_t access);
...
struct acpi_obj *
acpi_obj_resolve_implicit_refs(struct acpi_obj *obj);
...
struct acpi_obj *
acpi_create_package_obj(size_t entries);
...
int
acpi_obj_get_integral_value(struct acpi_obj *obj, unsigned long *value);
