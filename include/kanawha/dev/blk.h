...
#define BLOCK_DEVICE_NUM_SECTORS_SIG(RET, ARG, ...) RET(ssize_t)

#define BLOCK_DEVICE_SECTOR_ORDER_SIG(RET, ARG, ...) RET(order_t)
...
DEFINE_OP_LIST_WRAPPERS(BLOCK_DEVICE_OP_LIST,
                        static inline,
                        /* No Prefix */,
                        blk_dev,
