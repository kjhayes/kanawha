...
// EtherType fields/comments adapted from (https://en.wikipedia.org/wiki/EtherType)
typedef enum {
    ...
    ETH_TYPE_VLACP = 0x8103, //Virtual Link Aggregation Control Protocol (VLACP)
    ...
    ETH_TYPE_PTP = 0x88F7, //Precision Time Protocol (PTP) over IEEE 802.3 Ethernet
