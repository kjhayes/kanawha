...
#define __MACRO_CALL(__MACRO_FUNC,__ARGS) __EVAL(__MACRO_FUNC __MACRO_ARGS(__ARGS))
...
#define SIG_ARG_NAMES(SIG) __MACRO_CALL(__DROP_LEADING_COMMA, __SIG_ARG_NAMES(SIG))
#define SIG_ARG_TYPES(SIG) __MACRO_CALL(__DROP_LEADING_COMMA, __SIG_ARG_TYPES(SIG))
#define SIG_ARG_DECLS(SIG) __MACRO_CALL(__DROP_LEADING_COMMA, __SIG_ARG_DECLS(SIG))
