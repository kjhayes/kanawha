...
int perf_counter_register(struct perf_counter *metric, const char *name);
int perf_counter_unregister(struct perf_counter *metric);

int perf_timer_init(struct perf_timer *metric);
int perf_timer_register(struct perf_timer *metric, const char *name);
int perf_timer_unregister(struct perf_timer *metric);
