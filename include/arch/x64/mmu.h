...
#define X64_PML5_ENTRY_REGION_SIZE                                             \
    (X64_PML4_ENTRY_REGION_SIZE * X64_PML4_ENTRIES)
#define X64_PML4_SIZE 4096ULL
#define X64_PML4_ENTRIES 512ULL
#define X64_PML4_ALIGN 12ULL
#define X64_PML4_ENTRY_REGION_SIZE                                             \
    (X64_PDPT_ENTRY_REGION_SIZE * X64_PDPT_ENTRIES)
...
#define X64_PML5_INDEX_OF_ADDR(addr)                                           \
    (((addr) >> X64_PML5_INDEX_ADDR_SHIFT) & (X64_PML5_ENTRIES - 1))
#define X64_PML4_INDEX_OF_ADDR(addr)                                           \
    (((addr) >> X64_PML4_INDEX_ADDR_SHIFT) & (X64_PML4_ENTRIES - 1))
#define X64_PDPT_INDEX_OF_ADDR(addr)                                           \
    (((addr) >> X64_PDPT_INDEX_ADDR_SHIFT) & (X64_PDPT_ENTRIES - 1))
#define X64_PD_INDEX_OF_ADDR(addr)                                             \
    (((addr) >> X64_PD_INDEX_ADDR_SHIFT) & (X64_PD_ENTRIES - 1))
#define X64_PT_INDEX_OF_ADDR(addr)                                             \
    (((addr) >> X64_PT_INDEX_ADDR_SHIFT) & (X64_PT_ENTRIES - 1))
...
#define X64_PML5_ADDR_IS_CANONICAL(addr)                                       \
    (((addr & 0xFF80000000000000) == 0) ||                                     \
     ((addr & 0xFF80000000000000) == 0xFF80000000000000))
...
#define X64_PML4_ADDR_IS_CANONICAL(addr)                                       \
    (((addr & 0xFFFF800000000000) == 0) ||                                     \
     ((addr & 0xFFFF800000000000) == 0xFFFF800000000000))
