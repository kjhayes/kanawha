...
#define RISCV64_SV_LEVEL_1_INDEX_ADDR_SHIFT (RISCV64_SV_LEVEL_0_INDEX_ADDR_SHIFT + 9)
#define RISCV64_SV_LEVEL_2_INDEX_ADDR_SHIFT (RISCV64_SV_LEVEL_1_INDEX_ADDR_SHIFT + 9)
#define RISCV64_SV_LEVEL_3_INDEX_ADDR_SHIFT (RISCV64_SV_LEVEL_2_INDEX_ADDR_SHIFT + 9)
#define RISCV64_SV_LEVEL_4_INDEX_ADDR_SHIFT (RISCV64_SV_LEVEL_3_INDEX_ADDR_SHIFT + 9)

#define RISCV64_SV_LEVEL_0_INDEX_OF_ADDR(addr) (((addr)>>RISCV64_SV_LEVEL_0_INDEX_ADDR_SHIFT)&(RISCV64_SV_ENTRIES_PER_LEVEL-1))
#define RISCV64_SV_LEVEL_1_INDEX_OF_ADDR(addr) (((addr)>>RISCV64_SV_LEVEL_1_INDEX_ADDR_SHIFT)&(RISCV64_SV_ENTRIES_PER_LEVEL-1))
#define RISCV64_SV_LEVEL_2_INDEX_OF_ADDR(addr) (((addr)>>RISCV64_SV_LEVEL_2_INDEX_ADDR_SHIFT)&(RISCV64_SV_ENTRIES_PER_LEVEL-1))
#define RISCV64_SV_LEVEL_3_INDEX_OF_ADDR(addr) (((addr)>>RISCV64_SV_LEVEL_3_INDEX_ADDR_SHIFT)&(RISCV64_SV_ENTRIES_PER_LEVEL-1))
#define RISCV64_SV_LEVEL_4_INDEX_OF_ADDR(addr) (((addr)>>RISCV64_SV_LEVEL_4_INDEX_ADDR_SHIFT)&(RISCV64_SV_ENTRIES_PER_LEVEL-1))
