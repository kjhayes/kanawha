...
#define VGA_READ_REGISTER_ATTRIBUTES_R                                         \
    __maybe_unused __attribute__((always_inline)) inline
...
#define DEFINE_VGA_READ_ALT_MONO_PORT_REGISTER(__REG,                          \
                                               __PORT_MONO,                    \
                                               __PORT_COLOR,                   \
                                               __ACC)                          \
    static uint8_t vga_read_InputOutputAddressSelect_field(struct vga_dev *);  \
    VGA_READ_REGISTER_ATTRIBUTES_##__ACC static uint8_t                        \
...
#define DEFINE_VGA_WRITE_ALT_MONO_PORT_REGISTER(__REG,                         \
                                                __PORT_MONO,                   \
                                                __PORT_COLOR,                  \
                                                __ACC)                         \
    static uint8_t vga_read_InputOutputAddressSelect_field(struct vga_dev *);  \
    VGA_WRITE_REGISTER_ATTRIBUTES_##__ACC static void                          \
...
#define DEFINE_VGA_ALT_MONO_PORT_REGISTER_ACCESSORS(__REG,                     \
                                                    __MONO_PORT,               \
                                                    __COLOR_PORT,              \
                                                    __ACC)                     \
    DEFINE_VGA_READ_ALT_MONO_PORT_REGISTER(__REG,                              \
                                           __MONO_PORT,                        \
                                           __COLOR_PORT,                       \
                                           __ACC)                              \
    DEFINE_VGA_WRITE_ALT_MONO_PORT_REGISTER(__REG,                             \
                                            __MONO_PORT,                       \
                                            __COLOR_PORT,                      \
                                            __ACC)
...
#define DEFINE_VGA_READ_SPLIT_REGISTER(__REG, __READ_REG)                      \
    ...
    static uint8_t vga_read_##__REG##_register(struct vga_dev *dev)            \
    {                                                                          \
...
#define DEFINE_VGA_WRITE_SPLIT_REGISTER(__REG, __WRITE_REG)                    \
    ...
    static void vga_write_##__REG##_register(struct vga_dev *dev,              \
                                             uint8_t value)                    \
    {                                                                          \
...
#define DEFINE_VGA_WRITE_INDEXED_REGISTER(__REG, __REG_SET, __INDEX, __ACC)    \
    ...
    {                                                                          \
        ...
        DEBUG_ASSERT_MSG(vga_read_register(dev, __REG) == value,               \
                         "Found sticky bit in VGA register " #__REG "\n");     \
    }

#define DEFINE_VGA_INDEXED_REGISTER_ACCESSORS(__REG,                           \
                                              __REG_SET,                       \
                                              __INDEX,                         \
                                              __ACC)                           \
...
#define DEFINE_VGA_READ_FIELD(__FIELD, __REG, __MSB, __LSB)                    \
    static __maybe_unused uint8_t vga_read_##__FIELD##_field(                  \
        struct vga_dev *dev)                                                   \
    {                                                                          \
        int shift_amt = __LSB;                                                 \
...
#define DEFINE_VGA_WRITE_FIELD(__FIELD, __REG, __MSB, __LSB)                   \
    static __maybe_unused void vga_write_##__FIELD##_field(                    \
        struct vga_dev *dev,                                                   \
        uint8_t value)                                                         \
    {                                                                          \
        int shift_amt = __LSB;                                                 \
...
#define DEFINE_VGA_READ_DOUBLE_SPLIT_FIELD(__FIELD,                            \
                                           __REG1,                             \
                                           __MSB1,                             \
                                           __LSB1,                             \
                                           __REG0,                             \
                                           __MSB0,                             \
                                           __LSB0)                             \
    static __maybe_unused uint16_t vga_read_##__FIELD##_field(                 \
        struct vga_dev *dev)                                                   \
    {                                                                          \
        uint16_t value;                                                        \
        {                                                                      \
...
#define DEFINE_VGA_WRITE_DOUBLE_SPLIT_FIELD(__FIELD,                           \
                                            __REG1,                            \
                                            __MSB1,                            \
                                            __LSB1,                            \
                                            __REG0,                            \
...
#define DEFINE_VGA_DOUBLE_SPLIT_FIELD_ACCESSORS(__FIELD,                       \
                                                __REG1,                        \
                                                __MSB1,                        \
                                                __LSB1,                        \
                                                __REG0,                        \
                                                __MSB0,                        \
                                                __LSB0)                        \
    DEFINE_VGA_READ_DOUBLE_SPLIT_FIELD(__FIELD,                                \
                                       __REG1,                                 \
                                       __MSB1,                                 \
                                       __LSB1,                                 \
                                       __REG0,                                 \
                                       __MSB0,                                 \
                                       __LSB0)                                 \
    DEFINE_VGA_WRITE_DOUBLE_SPLIT_FIELD(__FIELD,                               \
                                        __REG1,                                \
                                        __MSB1,                                \
                                        __LSB1,                                \
                                        __REG0,                                \
...
#define DEFINE_VGA_READ_TRIPLE_SPLIT_FIELD(__FIELD,                            \
                                           __REG2,                             \
                                           __MSB2,                             \
                                           __LSB2,                             \
                                           __REG1,                             \
...
#define DEFINE_VGA_WRITE_TRIPLE_SPLIT_FIELD(__FIELD,                           \
                                            __REG2,                            \
                                            __MSB2,                            \
                                            __LSB2,                            \
                                            __REG1,                            \
...
#define DEFINE_VGA_TRIPLE_SPLIT_FIELD_ACCESSORS(__FIELD,                       \
                                                __REG2,                        \
                                                __MSB2,                        \
                                                __LSB2,                        \
                                                __REG1,                        \
                                                ...
                                                __MSB0,                        \
                                                __LSB0)                        \
    DEFINE_VGA_READ_TRIPLE_SPLIT_FIELD(__FIELD,                                \
                                       __REG2,                                 \
                                       __MSB2,                                 \
                                       __LSB2,                                 \
                                       __REG1,                                 \
                                       ...
                                       __MSB0,                                 \
                                       __LSB0)                                 \
    DEFINE_VGA_WRITE_TRIPLE_SPLIT_FIELD(__FIELD,                               \
                                        __REG2,                                \
                                        __MSB2,                                \
                                        __LSB2,                                \
                                        __REG1,                                \
...
void
vga_set_alphanumeric(struct vga_dev *dev, uint8_t value);
uint8_t
vga_get_alphanumeric(struct vga_dev *dev);
...
void
vga_crt_set_vertical_blanking_start(struct vga_dev *dev, uint16_t scanline);
void
vga_crt_set_vertical_blanking_end(struct vga_dev *dev, uint16_t scanline);
