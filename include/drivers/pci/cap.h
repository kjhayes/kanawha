...
pci_cap_readb(struct pci_func *func, struct pci_cap *cap, uint16_t offset)
{
    uint8_t val;
...
pci_cap_readw(struct pci_func *func, struct pci_cap *cap, uint16_t offset)
{
    uint16_t val;
...
pci_cap_readl(struct pci_func *func, struct pci_cap *cap, uint16_t offset)
{
    uint32_t val;
...
static inline int
pci_cap_writeb(struct pci_func *func,
               struct pci_cap *cap,
               uint16_t offset,
               uint8_t val)
{
...
static inline int
pci_cap_writew(struct pci_func *func,
               struct pci_cap *cap,
               uint16_t offset,
               uint16_t val)
{
...
static inline int
pci_cap_writel(struct pci_func *func,
               struct pci_cap *cap,
               uint16_t offset,
               uint32_t val)
{
