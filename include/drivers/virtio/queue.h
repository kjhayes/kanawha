...
_Static_assert(sizeof(struct virtio_queue_desc) == 16, "virtio_queue_desc is not 16 bytes wide!");
...
_Static_assert(sizeof(struct virtio_queue_avail) == 4, "virito_queue_avail is not 4 bytes wide!");
