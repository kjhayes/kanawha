...
#define VIRTIO_DEVICE_READ_STATUS_SIG(RET, ARG, ...) RET(uint8_t)

#define VIRTIO_DEVICE_SET_STATUS_SIG(RET, ARG, ...)                            \
    RET(int)                                                                   \
    ARG(uint8_t, mask_to_set)

#define VIRTIO_DEVICE_RESET_SIG(RET, ARG, ...) RET(int)
...
#define VIRTIO_DEVICE_INIT_QUEUES_SIG(RET, ARG, ...) RET(int)
#define VIRTIO_DEVICE_DEINIT_QUEUES_SIG(RET, ARG, ...) RET(int)
...
DEFINE_OP_LIST_WRAPPERS(VIRTIO_DEVICE_OP_LIST,
                        static inline,
                        /* No Prefix */,
                        virtio_device,
