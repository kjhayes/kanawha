...
OP(create_normal_transfer, USB_DEV_CREATE_NORMAL_TRANSFER_SIG, ##__VA_ARGS__)\
OP(create_setup_stage_transfer, USB_DEV_CREATE_SETUP_STAGE_TRANSFER_SIG, ##__VA_ARGS__)\
OP(create_data_stage_transfer, USB_DEV_CREATE_DATA_STAGE_TRANSFER_SIG, ##__VA_ARGS__)\
OP(create_status_stage_transfer, USB_DEV_CREATE_STATUS_STAGE_TRANSFER_SIG, ##__VA_ARGS__)\
OP(create_isoch_transfer, USB_DEV_CREATE_ISOCH_TRANSFER_SIG, ##__VA_ARGS__)\
