...
#define USB_DEVICE_DRIVER_OP_LIST(OP, ...)                                     \
    ...
    OP(configure_device,                                                       \
       USB_DEVICE_DRIVER_CONFIGURE_DEVICE_SIG,                                 \
       ##__VA_ARGS__)                                                          \
...
DEFINE_OP_LIST_WRAPPERS(USB_DEVICE_DRIVER_OP_LIST,
                        static inline,
                        /* No Prefix */,
                        usb_device_driver,
...
{
    DECLARE_OP_LIST_PTRS(USB_INTERFACE_DRIVER_OP_LIST,
                         struct usb_interface_driver *)
};
...
DEFINE_OP_LIST_WRAPPERS(USB_INTERFACE_DRIVER_OP_LIST,
                        static inline,
                        /* No Prefix */,
