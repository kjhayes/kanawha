...
static void
mb2_framebuffer_info_handler(struct mb2_info *info,
...
mb2_find_framebuffer(void)
{
    ...
    mb2_info_for_each_tag(info, mb2_framebuffer_info_handler, &res);

    return res;
}

declare_init_desc(device,
                  mb2_find_framebuffer,
                  "Looking for Framebuffer from Multiboot2 Info");
