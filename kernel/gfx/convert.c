...
static inline int
gfx_convert_to_rgba(unsigned long format,
                    void *data,
                    size_t bitoffset,
                    uint8_t *rgba_out)
{
...
static inline int
gfx_convert_from_rgba(uint32_t *rgba,
...
static inline int
gfx_convert_pixel(unsigned long from_format,
                  void *from_data,
                  ...
                  size_t to_bitoffset)
{
    ...
    int res = gfx_convert_to_rgba(from_format,
                                  from_data,
                                  from_bitoffset,
                                  (uint8_t *)&rgba);
    if(res)
    ...
    res = gfx_convert_from_rgba(&rgba, to_format, to_data, to_bitoffset);
    if(res)
    {
        return res;
    }
