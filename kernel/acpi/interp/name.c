                        ...
                        struct acpi_path **path_out)
{
    ...
    case AML_PARENT_PREFIX_OP:
        ...
        while(1)
        {
            ...
            if(res)
            {
                wprintk("acpi_interp_name_string: Failed to peek "
                        "byte after "
                        "parent prefix!\n");
                return res;
            }
    ...
    if(res)
    {
        wprintk("acpi_interp_name_string: Failed to peek first "
                "non-prefix byte!\n");
        return res;
    }
    ...
    case AML_MULTI_NAME_PREFIX:
        ...
        if(res)
        {
            wprintk("acpi_interp_name_string: Failed to read "
                    "MULTI_NAME_PREFIX "
                    "length!\n");
            return res;
        }
    ...
    for(size_t i = 0; i < pathlen; i++)
    {
        ...
        if(res)
        {
            wprintk("acpi_interp_name_string: Failed to read name "
                    "segment!\n");
