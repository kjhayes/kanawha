...
static int
ipv4_dev_init(struct ipv4_dev *dev)
{
...
static int
ipv4_dev_deinit(struct ipv4_dev *dev)
{
    printk("ipv4_dev unregistered: %s\n", ipv4_dev_get_name(dev));
    return 0;
}

DEFINE_DEV_TYPE(ipv4_dev, dev, ipv4_dev_init, ipv4_dev_deinit);

int
ipv4_dev_internal_on_recv(struct ipv4_dev *dev,
