...
static ssize_t
term_dev_stream_fs_file_read(struct file *file,
                             void *buffer,
                             ssize_t amount,
                             unsigned long flags)
{
...
static ssize_t
term_dev_stream_fs_file_write(struct file *file,
                              void *buffer,
                              ssize_t amount,
                              unsigned long flags)
{
...
static int
term_dev_stream_fs_file_flush(struct file *file, unsigned long flags)
{
    struct term_dev *dev = term_dev_from_file(file, stream_vfs_node);
...
static int
term_dev_stream_fs_node_setattr(struct fs_node *fs_node, int attr, size_t value)
{
...
static int
term_dev_stream_fs_node_getattr(struct fs_node *fs_node,
                                int attr,
                                size_t *value)
{
    struct term_dev *dev = term_dev_from_node(fs_node, stream_vfs_node);
...
static int
term_dev_stream_fs_file_poll(struct file *file,
...
int
term_dev_fs_node_init_stream(struct term_dev_fs_node *node)
{
...
int
term_dev_fs_node_deinit_stream(struct term_dev_fs_node *node)
{
